...
import com.wxw.rubbishApp.adapter.CarouselPagerAdapter;
import com.wxw.rubbishApp.ui.CarouselViewPager;
...
public class Fragment2 extends Fragment implements ViewPager.OnPageChangeListener {
    ...
    private int[] ivIds = {R.mipmap.garbage1, R.mipmap.garbage2, R.mipmap.garbage3, R.mipmap.garbage4};
    ...
    private void initData() {
        ...
        mCarouselView.setDisplayTime(10000);
        mCarouselView.start();
